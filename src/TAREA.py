...
def ejecutar_tarea1():
    ...
    overlay_plotter(time, x_t, n, x_n, title="señal senoidal continua y discreta", graph_label1="continua", graph_label2="discreta")
    ...
    overlay_plotter(time, x_t, n, x_n, title="señal exponencial continua y discreta", graph_label1="continua", graph_label2="discreta")
    ...
    overlay_plotter(time, x_t, n, x_n, title="señal triangular continua y discreta", graph_label1="continua", graph_label2="discreta")
    ...
    overlay_plotter(time, x_t, n, x_n, title="señal cuadrada continua y discreta", graph_label1="continua", graph_label2="discreta")